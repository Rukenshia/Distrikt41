/*
	File: fn_gatherLead.sqf
	Author: Distrikt41 - Dscha
	Description:
	Gathers copperore and reports it to DB?
*/
...
_type = "D41_KupferRoh";
_skill = life_skillCopperore;
_skillNeeded = {};
_skillAdd = {life_skillCopperore = life_skillCopperore + 1};
_hType = "Kupfererz"; //für TitleText
...
switch(true) do
{
	...
	case (_skill == 1249 && _CheckWerkzeug): 					{_Karma = 0; _LvL = 6; _rndm = [6,7] call BIS_fnc_selectRandom;	_count = "6-7";	_time = 12;	_Lcap = "MAX";	call _fnc_gather; [ format ["<t color='#9bbc57'><t size='1'>LEVEL UP!<br/>Skillstufe %1</t></t><br/> (%2/%3s): %4/%5",_LvL, _count, _time, _skill+1, _Lcap], SzoneXW, SzoneYH, 6, 1 ] spawn BIS_fnc_dynamicText;};
	//Level 5
